 ...
 */ !(function(t) {
  ...
  function(t, e) {
    ...
    window.tram = (function(t) {
      ...
      var l = (function(t, e, i) {
        ...
        S = function(t) {
          ...
          for (e = 0; e < M.length; e++)
            if ((n = M[e] + i) in j.style) return { dom: n, css: A[e] + t };
        },
        O = (e.support = {
      ...
      if (O.transition) {
        var q = O.timing.dom;
        if (((j.style[q] = f["ease-in-back"][0]), !j.style[q]))
          for (var $ in h) f[$][0] = h[$];
      }
      var D = (e.frame = (function() {
        ...
        F = l(function(e) {
            ...
            if (t) {
              ...
              if ("object" == o) {
                ...
                d.call(
                  ...
                  h.call(this),
                  c > 0 &&
                    ((this.timer = new X({ duration: c, context: this })),
                    (this.active = !0),
          ...
          (e.init = function(e) {
            ...
            O.backface &&
              H.hideBackface &&
              W(this.el, O.backface.css, "hidden");
          }),
            b("add", r),
            b("start", o),
            b("wait", function(t) {
        ...
        B = l(function(e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (D(n), e = L(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      var W = t.style,
        Y = t.css,
        G = { transform: O.transform && O.transform.css },
        Z = {
          color: [P, b],
